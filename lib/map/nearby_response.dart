...
class Geometry {
  ...
  Geometry.fromJson(Map<String, dynamic> json) {
    location = json['location'] != null
        ? N_Location.fromJson(json['location'])
        : null;
...
class N_Location {
  ...
  N_Location({this.lat, this.lng});

  N_Location.fromJson(Map<String, dynamic> json) {
    lat = json['lat'];
    lng = json['lng'];
  }
...
class Viewport {
  N_Location? northeast;
  N_Location? southwest;

  Viewport({this.northeast, this.southwest});

  Viewport.fromJson(Map<String, dynamic> json) {
    northeast = json['northeast'] != null
        ? N_Location.fromJson(json['northeast'])
        : null;
    southwest = json['southwest'] != null
        ? N_Location.fromJson(json['southwest'])
        : null;
  }
